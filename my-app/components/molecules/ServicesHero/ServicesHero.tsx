...
const ServicesHero = () => {
    return (
        <div className='w-full max-w-480 pt-[clamp(60px,12vh,155px)] flex flex-col gap-6 lg:gap-12'>
            ...
            <div className='w-full grid grid-cols-1 sm:grid-cols-[1fr_auto] items-center gap-x-4 gap-y-4 sm:gap-10 md:gap-16'>
                <ServiceItem
                    number='Architecture'
                    text='We conceive building as enduring contributions to the landscape, balancing conceptual rigor with technical excelence '
                    categories={['Residential', 'Commercial', 'restorations', 'Public spaces']}
                />
                <ServiceItem
                    number='Interior Design'
                    text='Creating immersive environments that tell a story, prioritizing human experience through light, material, and scale. '
                    categories={['Hospitality', 'Retail', 'Exhibition Design', 'Residential']}
                />
                <ServiceItem
                    number='Product Design'
