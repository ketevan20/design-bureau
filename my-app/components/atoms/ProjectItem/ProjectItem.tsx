    ...
    return (
        <div className='group p-3 bg-white flex flex-col gap-3 h-full overflow-hidden cursor-pointer'>
            <div className='relative overflow-hidden'>
                <img src={image} alt="" className='aspect-400/267 w-full object-cover overflow-hidden grayscale group-hover:grayscale-0 group-hover:scale-110 origin-center transition-all duration-1000 ease-out' />
